...
export interface LogConfig {
  ...
  GLOSSARY_ORCHESTRATOR: boolean;
  ANALYSIS_ORCHESTRATOR: boolean;
...
export const LOG_CONFIG: LogConfig = {
  ...
  GLOSSARY_ORCHESTRATOR: false,   // Glossary orchestrator
  ANALYSIS_ORCHESTRATOR: false,   // Analysis orchestrator
  ...
  IMAGE_REPO: false,              // Image repository operations
  CHUNK_REPO: false,              // Chunk repository operations
  CITATION_REPO: false,           // Citation repository operations
  PAPER_REPO: false,              // Paper repository operations
  ...
  // Utils
  UTILS: false,                   // Utility functions and classes
