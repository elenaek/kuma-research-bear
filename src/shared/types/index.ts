...
export enum MessageType {
  ...
  GLOSSARY_BATCH_COMPLETE = 'GLOSSARY_BATCH_COMPLETE',
  GENERATE_EMBEDDINGS = 'GENERATE_EMBEDDINGS',
  PRELOAD_EMBEDDINGS = 'PRELOAD_EMBEDDINGS', // Trigger embedding model preload during initialization
  ...
  CAPTURE_PDF_SCREENSHOT = 'CAPTURE_PDF_SCREENSHOT',
...
export interface ChatTab {
  ...
  overlayPosition?: { // For screen capture tabs only - stored position for compass after refresh
    pageX: number;
    pageY: number;
    width: number;
    height: number;
